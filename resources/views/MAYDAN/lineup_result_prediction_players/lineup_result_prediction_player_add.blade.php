                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('lineup_result_prediction_players.index') }}">{{ __('lineup_result_prediction_players_lineup_result_prediction_players') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new lineup_result_prediction_players_lineup_result_prediction_player') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/lineup_result_prediction_players') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('fixture_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.lineup_result_prediction_players_fixture_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="fixture_id" placeholder="@lang('messages.lineup_result_prediction_players_fixture_id')" value="{{ old('fixture_id') }}">
       ...
       <div class="form-group{{ $errors->has('prediction_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.lineup_result_prediction_players_prediction_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="prediction_id" placeholder="@lang('messages.lineup_result_prediction_players_prediction_id')" value="{{ old('prediction_id') }}">
       ...
       <div class="form-group{{ $errors->has('player_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.lineup_result_prediction_players_player_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="player_id" placeholder="@lang('messages.lineup_result_prediction_players_player_id')" value="{{ old('player_id') }}">
       ...
       <div class="form-group{{ $errors->has('player_name') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.lineup_result_prediction_players_player_name')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="player_name" placeholder="@lang('messages.lineup_result_prediction_players_player_name')" value="{{ old('player_name') }}">
       ...
       <div class="form-group{{ $errors->has('player_key') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.lineup_result_prediction_players_player_key')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="player_key" placeholder="@lang('messages.lineup_result_prediction_players_player_key')" value="{{ old('player_key') }}">
