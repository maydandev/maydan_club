                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('votes.index') }}">{{ __('votes_votes') }}</a>
								     ...
								     <li class="breadcrumb-item active">{{ __('Add new votes_Vote') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/votes') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('headline') ? ' has-error' : '' }}">
         <label class="col-md-12">{{ __('Headline') }} <span class="text-danger">*</span></label>
                            <div class="col-md-12 ">
                                <input type="text" class="form-control form-control-line" name="headline" placeholder="{{ __('Headline') }}" value="{{ old('headline') }}" required >
    ...
    @include('MAYDAN.custom.application_football_teams_add')  
       ...
       <div class="form-group{{ $errors->has('question') ? ' has-error' : '' }}">
         <label class="col-md-12">{{ __('Question') }} <span class="text-danger">*</span></label>
                            <div class="col-md-12 ">
                                <input type="text" class="form-control form-control-line" name="question" placeholder="{{ __('Question') }}" value="{{ old('question') }}" required >
...
<div class="form-group dynamic-fields-container">
    <div class="col-md-12 dynamic-fields-inputs">
        ...
        <div id="dynamic-fields-inputs-sample">
            <div class="input-group mb-2">
                <input type="text" class="form-control"  name="question_option[]" placeholder="{{ __('Option') }} 1" required>
        ...
        <div class="input-group mb-2">
            <input type="text" class="form-control" name="question_option[]" placeholder="{{ __('Option') }} 2" required>
            <div class="input-group-append">
                <span
                    class="input-group-text btn btn-danger disabled dynamic-fields-inputs-sample-close"><i
                        class="feather icon-delete"></i></span>
    ...
    <div class="col-md-12 dynamic-fields-button">
       ...
       <div class="form-group{{ $errors->has('deadline') ? ' has-error' : '' }}">
         <label class="col-md-12">@lang('votes_deadline') <span class="text-danger">*</span></label>
                            <div class="col-md-12 ">
                                <input type="date" class="form-control form-control-line" name="deadline" placeholder="@lang('votes_deadline')" value="{{ old('deadline') }}" required >
    ...
    <div class="form-group{{ $errors->has('deadline') ? ' has-error' : '' }}">
         <label class="col-md-12">@lang('votes_deadline_time') <span class="text-danger">*</span></label>
                            <div class="col-md-12 ">
                                <input type="time" class="form-control form-control-line" name="deadline_time" placeholder="@lang('votes_deadline_time')" value="{{ old('deadline') }}" required >
                                @if ($errors->has('deadline'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('deadline') }}</strong>
                                    </span>
             ...
             <button type="submit" class="btn btn-primary" dir="rtl" >{{ __('Submit') }}</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
