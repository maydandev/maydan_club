                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('social_media_links.index') }}">{{ __('social_media_links_social_media_links') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new social_media_links_social_media_link') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/social_media_links') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('application_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.social_media_links_application_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="application_id" placeholder="@lang('messages.social_media_links_application_id')" value="{{ old('application_id') }}">
       ...
       <div class="form-group{{ $errors->has('link') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.social_media_links_link')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="link" placeholder="@lang('messages.social_media_links_link')" value="{{ old('link') }}">
                                @if ($errors->has('link'))
                                    <span class="help-block">
