                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('final_result_predictions.index') }}">{{ __('final_result_predictions_final_result_predictions') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new final_result_predictions_final_result_prediction') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/final_result_predictions') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('fixture_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.final_result_predictions_fixture_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="fixture_id" placeholder="@lang('messages.final_result_predictions_fixture_id')" value="{{ old('fixture_id') }}">
       ...
       <div class="form-group{{ $errors->has('home_team_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.final_result_predictions_home_team_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="home_team_id" placeholder="@lang('messages.final_result_predictions_home_team_id')" value="{{ old('home_team_id') }}">
       ...
       <div class="form-group{{ $errors->has('away_team_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.final_result_predictions_away_team_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="away_team_id" placeholder="@lang('messages.final_result_predictions_away_team_id')" value="{{ old('away_team_id') }}">
       ...
       <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.final_result_predictions_status')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="status" placeholder="@lang('messages.final_result_predictions_status')" value="{{ old('status') }}">
       ...
       <div class="form-group{{ $errors->has('result_home_team') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.final_result_predictions_result_home_team')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="result_home_team" placeholder="@lang('messages.final_result_predictions_result_home_team')" value="{{ old('result_home_team') }}">
       ...
       <div class="form-group{{ $errors->has('result_away_team') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.final_result_predictions_result_away_team')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="result_away_team" placeholder="@lang('messages.final_result_predictions_result_away_team')" value="{{ old('result_away_team') }}">
...
<span class="lbl"></span>
       ...
       <div class="form-group{{ $errors->has('prediction_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.final_result_predictions_prediction_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="prediction_id" placeholder="@lang('messages.final_result_predictions_prediction_id')" value="{{ old('prediction_id') }}">
       ...
       <div class="form-group{{ $errors->has('data') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6  ">
                                <textarea  class="form-control" name="data" placeholder="@lang('messages.final_result_predictions_data')"  >{{ old('data') }}</textarea>
                                @if ($errors->has('data'))
                                    <span class="help-block">
