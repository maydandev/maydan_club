                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('clients.index') }}">{{ __('clients_clients') }}</a>
								     ...
								     <li class="breadcrumb-item active">{{ __('Add new clients_client') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/clients') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('icon') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.clients_icon')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="icon" placeholder="@lang('messages.clients_icon')" value="{{ old('icon') }}">
                                @if ($errors->has('icon'))
       ...
       <div class="form-group{{ $errors->has('team_name') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.clients_team_name')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="team_name" placeholder="@lang('messages.clients_team_name')" value="{{ old('team_name') }}">
       ...
       <div class="form-group{{ $errors->has('country') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.clients_country')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="country" placeholder="@lang('messages.clients_country')" value="{{ old('country') }}">
...
<span class="lbl"></span>
       ...
       <div class="form-group{{ $errors->has('sort') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.clients_sort')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="sort" placeholder="@lang('messages.clients_sort')" value="{{ old('sort') }}">
                                @if ($errors->has('sort'))
                                    <span class="help-block">
