                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('contacts.index') }}">{{ __('contacts_contacts') }}</a>
								     ...
								     <li class="breadcrumb-item active">  @lang('messages.contacts_show_title') {{$contact->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/contacts/{{$contact->id}}"   enctype="multipart/form-data"  novalidate>
...
<span class="lbl"></span>
  ...
  <ul class="pager">
                 @if($previous)
											<li class="previous">
												<a href="/contacts/{{$previous}}"><i class="ace-icon fa fa-angle-double-right"></i> @lang('messages.previous')   </a>
											</li>
                @endif
                @if($next)
											<li class="next">
												<a href="/contacts/{{$next}}"> @lang('messages.next')   <i class="ace-icon fa fa-angle-double-left"></i> </a>
											</li>
                @endif
	</ul>
