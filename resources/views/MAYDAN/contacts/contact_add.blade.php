                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('contacts.index') }}">{{ __('contacts_contacts') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new contacts_contact') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/contacts') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('application_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.contacts_application_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="application_id" placeholder="@lang('messages.contacts_application_id')" value="{{ old('application_id') }}">
       ...
       <div class="form-group{{ $errors->has('purpose') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6  ">
                                <textarea  class="form-control" name="purpose" placeholder="@lang('messages.contacts_purpose')"  >{{ old('purpose') }}</textarea>
       ...
       <div class="form-group{{ $errors->has('phone_number') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.contacts_phone_number')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="phone_number" placeholder="@lang('messages.contacts_phone_number')" value="{{ old('phone_number') }}">
       ...
       <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.contacts_email')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="email" placeholder="@lang('messages.contacts_email')" value="{{ old('email') }}">
                                @if ($errors->has('email'))
                                    <span class="help-block">
       ...
       <div class="form-group{{ $errors->has('working_days') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.contacts_working_days')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="working_days" placeholder="@lang('messages.contacts_working_days')" value="{{ old('working_days') }}">
       ...
       <div class="form-group{{ $errors->has('working_hours_from') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.contacts_working_hours_from')</label>
                            <div class="col-md-6  ">
                                <input type="date" class="form-control" name="working_hours_from" placeholder="@lang('messages.contacts_working_hours_from')" value="{{ old('working_hours_from') }}">
       ...
       <div class="form-group{{ $errors->has('working_hours_to') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.contacts_working_hours_to')</label>
                            <div class="col-md-6  ">
                                <input type="date" class="form-control" name="working_hours_to" placeholder="@lang('messages.contacts_working_hours_to')" value="{{ old('working_hours_to') }}">
