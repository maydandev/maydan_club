...
@section('content-header')
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{ __('quizze_questions_quizze_questions') }}</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('quizze_questions.index') }}">{{ __('quizze_questions_quizze_questions') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new quizze_questions_quizze_question') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/quizze_questions') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('quizze_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.quizze_questions_quizze_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="quizze_id" placeholder="@lang('messages.quizze_questions_quizze_id')" value="{{ old('quizze_id') }}">
       ...
       <div class="form-group{{ $errors->has('quizze_question') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.quizze_questions_quizze_question')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="quizze_question" placeholder="@lang('messages.quizze_questions_quizze_question')" value="{{ old('quizze_question') }}">
       ...
       <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.quizze_questions_image') </label>
                            <div class="col-md-6  ">
                                <input type="file" class="form-control" name="image" placeholder="@lang('messages.quizze_questions_image')" value="{{ old('image') }}">
                                @if ($errors->has('image'))
                                    <span class="help-block">
       ...
       <div class="form-group{{ $errors->has('points') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.quizze_questions_points')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="points" placeholder="@lang('messages.quizze_questions_points')" value="{{ old('points') }}">
       ...
       <div class="form-group{{ $errors->has('quizze_question_option_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.quizze_questions_quizze_question_option_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="quizze_question_option_id" placeholder="@lang('messages.quizze_questions_quizze_question_option_id')" value="{{ old('quizze_question_option_id') }}">
