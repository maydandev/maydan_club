...
@section('content-header')
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{ __('lineup_predictions_lineup_predictions') }}</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('lineup_predictions.index') }}">{{ __('lineup_predictions_lineup_predictions') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new lineup_predictions_lineup_prediction') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/lineup_predictions') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('fixture_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.lineup_predictions_fixture_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="fixture_id" placeholder="@lang('messages.lineup_predictions_fixture_id')" value="{{ old('fixture_id') }}">
       ...
       <div class="form-group{{ $errors->has('prediction_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.lineup_predictions_prediction_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="prediction_id" placeholder="@lang('messages.lineup_predictions_prediction_id')" value="{{ old('prediction_id') }}">
       ...
       <div class="form-group{{ $errors->has('data') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6  ">
                                <textarea  class="form-control" name="data" placeholder="@lang('messages.lineup_predictions_data')"  >{{ old('data') }}</textarea>
                                @if ($errors->has('data'))
                                    <span class="help-block">
