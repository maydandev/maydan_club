...
@section('content-header')
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{ __('quizze_question_options_quizze_question_options') }}</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('quizze_question_options.index') }}">{{ __('quizze_question_options_quizze_question_options') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new quizze_question_options_quizze_question_option') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/quizze_question_options') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('quizze_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.quizze_question_options_quizze_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="quizze_id" placeholder="@lang('messages.quizze_question_options_quizze_id')" value="{{ old('quizze_id') }}">
       ...
       <div class="form-group{{ $errors->has('quizze_question_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.quizze_question_options_quizze_question_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="quizze_question_id" placeholder="@lang('messages.quizze_question_options_quizze_question_id')" value="{{ old('quizze_question_id') }}">
       ...
       <div class="form-group{{ $errors->has('quizze_option_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.quizze_question_options_quizze_option_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="quizze_option_id" placeholder="@lang('messages.quizze_question_options_quizze_option_id')" value="{{ old('quizze_option_id') }}">
       ...
       <div class="form-group{{ $errors->has('is_best_answer') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.quizze_question_options_is_best_answer')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="is_best_answer" placeholder="@lang('messages.quizze_question_options_is_best_answer')" value="{{ old('is_best_answer') }}">
