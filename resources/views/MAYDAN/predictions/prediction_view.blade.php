                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('predictions.index') }}">{{ __('predictions_predictions') }}</a>
                                    </li>
								     <li class="breadcrumb-item active">  @lang('predictions_show_title') {{$prediction->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/predictions/{{$prediction->id}}"   enctype="multipart/form-data"  novalidate>
