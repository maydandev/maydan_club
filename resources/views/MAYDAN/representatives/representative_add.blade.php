...
@section('content-header')
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{ __('representatives_representatives') }}</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('representatives.index') }}">{{ __('representatives_representatives') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new representatives_representative') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/representatives') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.representatives_name')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="name" placeholder="@lang('messages.representatives_name')" value="{{ old('name') }}">
                                @if ($errors->has('name'))
                                    <span class="help-block">
       ...
       <div class="form-group{{ $errors->has('position') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.representatives_position')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="position" placeholder="@lang('messages.representatives_position')" value="{{ old('position') }}">
       ...
       <div class="form-group{{ $errors->has('phone_number') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.representatives_phone_number')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="phone_number" placeholder="@lang('messages.representatives_phone_number')" value="{{ old('phone_number') }}">
       ...
       <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.representatives_email')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="email" placeholder="@lang('messages.representatives_email')" value="{{ old('email') }}">
                                @if ($errors->has('email'))
                                    <span class="help-block">
