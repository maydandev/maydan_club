                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('genders.index') }}">{{ __('genders_genders') }}</a>
								     ...
								     <li class="breadcrumb-item active">  @lang('messages.genders_show_title') {{$gender->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/genders/{{$gender->id}}"   enctype="multipart/form-data"  novalidate>
  ...
  <ul class="pager">
                 @if($previous)
											<li class="previous">
												<a href="/genders/{{$previous}}"><i class="ace-icon fa fa-angle-double-right"></i> @lang('messages.previous')   </a>
											</li>
                @endif
                @if($next)
											<li class="next">
												<a href="/genders/{{$next}}"> @lang('messages.next')   <i class="ace-icon fa fa-angle-double-left"></i> </a>
											</li>
                @endif
	</ul>
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('genders.index') }}">{{ __('genders_genders') }}</a>
								     ...
								     <li class="breadcrumb-item active">  @lang('genders_show_title') {{$gender->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
