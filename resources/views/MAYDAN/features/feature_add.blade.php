                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('features.index') }}">{{ __('features_features') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new features_feature') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/features') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.features_title')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="title" placeholder="@lang('messages.features_title')" value="{{ old('title') }}">
                                @if ($errors->has('title'))
       ...
       <div class="form-group{{ $errors->has('text') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6  ">
                                <textarea  class="form-control" name="text" placeholder="@lang('messages.features_text')"  >{{ old('text') }}</textarea>
                                @if ($errors->has('text'))
                                    <span class="help-block">
       ...
       <div class="form-group{{ $errors->has('icon') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.features_icon')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="icon" placeholder="@lang('messages.features_icon')" value="{{ old('icon') }}">
                                @if ($errors->has('icon'))
                                    <span class="help-block">
       ...
       <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.features_image') </label>
                            <div class="col-md-6  ">
                                <input type="file" class="form-control" name="image" placeholder="@lang('messages.features_image')" value="{{ old('image') }}">
                                @if ($errors->has('image'))
                                    <span class="help-block">
       ...
       <div class="form-group{{ $errors->has('text_align') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.features_text_align')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="text_align" placeholder="@lang('messages.features_text_align')" value="{{ old('text_align') }}">
       ...
       <div class="form-group{{ $errors->has('sort') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.features_sort')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="sort" placeholder="@lang('messages.features_sort')" value="{{ old('sort') }}">
                                @if ($errors->has('sort'))
                                    <span class="help-block">
