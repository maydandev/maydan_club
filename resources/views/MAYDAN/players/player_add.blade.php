                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('players.index') }}">{{ __('players_players') }}</a>
								     ...
								     <li class="breadcrumb-item active">{{ __('Add new players_player') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/players') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('team_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.players_team_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="team_id" placeholder="@lang('messages.players_team_id')" value="{{ old('team_id') }}">
       ...
       <div class="form-group{{ $errors->has('season') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.players_season')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="season" placeholder="@lang('messages.players_season')" value="{{ old('season') }}">
       ...
       <div class="form-group{{ $errors->has('player_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.players_player_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="player_id" placeholder="@lang('messages.players_player_id')" value="{{ old('player_id') }}">
       ...
       <div class="form-group{{ $errors->has('player_name') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.players_player_name')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="player_name" placeholder="@lang('messages.players_player_name')" value="{{ old('player_name') }}">
       ...
       <div class="form-group{{ $errors->has('firstname') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.players_firstname')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="firstname" placeholder="@lang('messages.players_firstname')" value="{{ old('firstname') }}">
       ...
       <div class="form-group{{ $errors->has('lastname') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.players_lastname')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="lastname" placeholder="@lang('messages.players_lastname')" value="{{ old('lastname') }}">
       ...
       <div class="form-group{{ $errors->has('number') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.players_number')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="number" placeholder="@lang('messages.players_number')" value="{{ old('number') }}">
       ...
       <div class="form-group{{ $errors->has('position') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.players_position')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="position" placeholder="@lang('messages.players_position')" value="{{ old('position') }}">
       ...
       <div class="form-group{{ $errors->has('age') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.players_age')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="age" placeholder="@lang('messages.players_age')" value="{{ old('age') }}">
                                @if ($errors->has('age'))
                                    <span class="help-block">
       ...
       <div class="form-group{{ $errors->has('birth_date') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.players_birth_date')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="birth_date" placeholder="@lang('messages.players_birth_date')" value="{{ old('birth_date') }}">
       ...
       <div class="form-group{{ $errors->has('birth_place') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.players_birth_place')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="birth_place" placeholder="@lang('messages.players_birth_place')" value="{{ old('birth_place') }}">
       ...
       <div class="form-group{{ $errors->has('birth_country') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.players_birth_country')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="birth_country" placeholder="@lang('messages.players_birth_country')" value="{{ old('birth_country') }}">
       ...
       <div class="form-group{{ $errors->has('nationality') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.players_nationality')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="nationality" placeholder="@lang('messages.players_nationality')" value="{{ old('nationality') }}">
       ...
       <div class="form-group{{ $errors->has('height') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.players_height')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="height" placeholder="@lang('messages.players_height')" value="{{ old('height') }}">
       ...
       <div class="form-group{{ $errors->has('weight') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.players_weight')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="weight" placeholder="@lang('messages.players_weight')" value="{{ old('weight') }}">
