...
@section('content-header')
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{ __('football_team_posts_football_team_posts') }}</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('football_team_posts.index') }}">{{ __('football_team_posts_football_team_posts') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new football_team_posts_football_team_post') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/football_team_posts') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('post_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.football_team_posts_post_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="post_id" placeholder="@lang('messages.football_team_posts_post_id')" value="{{ old('post_id') }}">
       ...
       <div class="form-group{{ $errors->has('football_team_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.football_team_posts_football_team_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="football_team_id" placeholder="@lang('messages.football_team_posts_football_team_id')" value="{{ old('football_team_id') }}">
