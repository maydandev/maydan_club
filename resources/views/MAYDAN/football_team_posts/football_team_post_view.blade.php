                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('football_team_posts.index') }}">{{ __('football_team_posts_football_team_posts') }}</a>
								     ...
								     <li class="breadcrumb-item active">  @lang('messages.football_team_posts_show_title') {{$football_team_post->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/football_team_posts/{{$football_team_post->id}}"   enctype="multipart/form-data"  novalidate>
  ...
  <ul class="pager">
                 @if($previous)
											<li class="previous">
												<a href="/football_team_posts/{{$previous}}"><i class="ace-icon fa fa-angle-double-right"></i> @lang('messages.previous')   </a>
											</li>
                @endif
                @if($next)
											<li class="next">
												<a href="/football_team_posts/{{$next}}"> @lang('messages.next')   <i class="ace-icon fa fa-angle-double-left"></i> </a>
											</li>
                @endif
	</ul>
