                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('leagues.index') }}">{{ __('leagues_leagues') }}</a>
								     ...
								     <li class="breadcrumb-item active">{{ __('Add new leagues_league') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/leagues') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('league_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.leagues_league_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="league_id" placeholder="@lang('messages.leagues_league_id')" value="{{ old('league_id') }}">
       ...
       <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.leagues_name')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="name" placeholder="@lang('messages.leagues_name')" value="{{ old('name') }}">
                                @if ($errors->has('name'))
                                    <span class="help-block">
       ...
       <div class="form-group{{ $errors->has('league_type_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.leagues_league_type_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="league_type_id" placeholder="@lang('messages.leagues_league_type_id')" value="{{ old('league_type_id') }}">
       ...
       <div class="form-group{{ $errors->has('country_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.leagues_country_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="country_id" placeholder="@lang('messages.leagues_country_id')" value="{{ old('country_id') }}">
       ...
       <div class="form-group{{ $errors->has('season') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.leagues_season')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="season" placeholder="@lang('messages.leagues_season')" value="{{ old('season') }}">
       ...
       <div class="form-group{{ $errors->has('season_start') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.leagues_season_start')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="season_start" placeholder="@lang('messages.leagues_season_start')" value="{{ old('season_start') }}">
       ...
       <div class="form-group{{ $errors->has('season_end') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.leagues_season_end')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="season_end" placeholder="@lang('messages.leagues_season_end')" value="{{ old('season_end') }}">
       ...
       <div class="form-group{{ $errors->has('logo') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.leagues_logo') </label>
                            <div class="col-md-6  ">
                                <input type="file" class="form-control" name="logo" placeholder="@lang('messages.leagues_logo')" value="{{ old('logo') }}">
                                @if ($errors->has('logo'))
                                    <span class="help-block">
       ...
       <div class="form-group{{ $errors->has('flag') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.leagues_flag')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="flag" placeholder="@lang('messages.leagues_flag')" value="{{ old('flag') }}">
                                @if ($errors->has('flag'))
                                    <span class="help-block">
       ...
       <div class="form-group{{ $errors->has('standings') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.leagues_standings')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="standings" placeholder="@lang('messages.leagues_standings')" value="{{ old('standings') }}">
       ...
       <div class="form-group{{ $errors->has('is_current') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.leagues_is_current')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="is_current" placeholder="@lang('messages.leagues_is_current')" value="{{ old('is_current') }}">
       ...
       <div class="form-group{{ $errors->has('coverage_standings') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.leagues_coverage_standings')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="coverage_standings" placeholder="@lang('messages.leagues_coverage_standings')" value="{{ old('coverage_standings') }}">
       ...
       <div class="form-group{{ $errors->has('coverage_fixtures_events') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.leagues_coverage_fixtures_events')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="coverage_fixtures_events" placeholder="@lang('messages.leagues_coverage_fixtures_events')" value="{{ old('coverage_fixtures_events') }}">
       ...
       <div class="form-group{{ $errors->has('coverage_fixtures_lineups') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.leagues_coverage_fixtures_lineups')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="coverage_fixtures_lineups" placeholder="@lang('messages.leagues_coverage_fixtures_lineups')" value="{{ old('coverage_fixtures_lineups') }}">
       ...
       <div class="form-group{{ $errors->has('coverage_fixtures_statistics') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.leagues_coverage_fixtures_statistics')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="coverage_fixtures_statistics" placeholder="@lang('messages.leagues_coverage_fixtures_statistics')" value="{{ old('coverage_fixtures_statistics') }}">
       ...
       <div class="form-group{{ $errors->has('coverage_fixtures_players_statistics') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.leagues_coverage_fixtures_players_statistics')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="coverage_fixtures_players_statistics" placeholder="@lang('messages.leagues_coverage_fixtures_players_statistics')" value="{{ old('coverage_fixtures_players_statistics') }}">
       ...
       <div class="form-group{{ $errors->has('coverage_players') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.leagues_coverage_players')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="coverage_players" placeholder="@lang('messages.leagues_coverage_players')" value="{{ old('coverage_players') }}">
       ...
       <div class="form-group{{ $errors->has('coverage_topscorers') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.leagues_coverage_topscorers')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="coverage_topscorers" placeholder="@lang('messages.leagues_coverage_topscorers')" value="{{ old('coverage_topscorers') }}">
       ...
       <div class="form-group{{ $errors->has('coverage_predictions') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.leagues_coverage_predictions')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="coverage_predictions" placeholder="@lang('messages.leagues_coverage_predictions')" value="{{ old('coverage_predictions') }}">
       ...
       <div class="form-group{{ $errors->has('coverage_odds') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.leagues_coverage_odds')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="coverage_odds" placeholder="@lang('messages.leagues_coverage_odds')" value="{{ old('coverage_odds') }}">
