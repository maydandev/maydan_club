...
@section('content-header')
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{ __('quizze_answers_quizze_answers') }}</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('quizze_answers.index') }}">{{ __('quizze_answers_quizze_answers') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new quizze_answers_quizze_answer') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/quizze_answers') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('user_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.quizze_answers_user_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="user_id" placeholder="@lang('messages.quizze_answers_user_id')" value="{{ old('user_id') }}">
       ...
       <div class="form-group{{ $errors->has('quizze_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.quizze_answers_quizze_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="quizze_id" placeholder="@lang('messages.quizze_answers_quizze_id')" value="{{ old('quizze_id') }}">
       ...
       <div class="form-group{{ $errors->has('quizze_question_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.quizze_answers_quizze_question_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="quizze_question_id" placeholder="@lang('messages.quizze_answers_quizze_question_id')" value="{{ old('quizze_question_id') }}">
       ...
       <div class="form-group{{ $errors->has('quizze_question_option_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.quizze_answers_quizze_question_option_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="quizze_question_option_id" placeholder="@lang('messages.quizze_answers_quizze_question_option_id')" value="{{ old('quizze_question_option_id') }}">
       ...
       <div class="form-group{{ $errors->has('result_points') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.quizze_answers_result_points')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="result_points" placeholder="@lang('messages.quizze_answers_result_points')" value="{{ old('result_points') }}">
