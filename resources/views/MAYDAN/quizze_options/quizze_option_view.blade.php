...
@section('content-header')
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{ __('quizze_options_quizze_options') }}</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('quizze_options.index') }}">{{ __('quizze_options_quizze_options') }}</a>
                                    </li>
								     <li class="breadcrumb-item active">  @lang('messages.quizze_options_show_title') {{$quizze_option->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/quizze_options/{{$quizze_option->id}}"   enctype="multipart/form-data"  novalidate>
  ...
  {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('quizze_id') ? ' has-error' : '' }}">
            <label class="col-md-4 control-label  "> @lang('messages.quizze_options_quizze_id')</label>
                            <div class="col-md-6 ">
                                <input type="number" class="form-control" name="quizze_id" placeholder="@lang('messages.quizze_options_quizze_id')" value="{{ $quizze_option->quizze_id }}">
       ...
       <div class="form-group{{ $errors->has('quizze_option') ? ' has-error' : '' }}">
            <label class="col-md-4 control-label  "> @lang('messages.quizze_options_quizze_option')</label>
                            <div class="col-md-6 ">
                                <input type="text" class="form-control" name="quizze_option" placeholder="@lang('messages.quizze_options_quizze_option')" value="{{ $quizze_option->quizze_option }}">
                                @if ($errors->has('quizze_option'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('quizze_option') }}</strong>
                                    </span>
                                @endif
                            </div>
  ...
  <ul class="pager">
                 @if($previous)
											<li class="previous">
												<a href="/quizze_options/{{$previous}}"><i class="ace-icon fa fa-angle-double-right"></i> @lang('messages.previous')   </a>
											</li>
                @endif
                @if($next)
											<li class="next">
												<a href="/quizze_options/{{$next}}"> @lang('messages.next')   <i class="ace-icon fa fa-angle-double-left"></i> </a>
											</li>
                @endif
	</ul>
