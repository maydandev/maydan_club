                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('quizze_options.index') }}">{{ __('quizze_options_quizze_options') }}</a>
								     ...
								     <li class="breadcrumb-item active">{{ __('Add new quizze_options_quizze_option') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/quizze_options') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('quizze_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.quizze_options_quizze_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="quizze_id" placeholder="@lang('messages.quizze_options_quizze_id')" value="{{ old('quizze_id') }}">
       ...
       <div class="form-group{{ $errors->has('quizze_option') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.quizze_options_quizze_option')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="quizze_option" placeholder="@lang('messages.quizze_options_quizze_option')" value="{{ old('quizze_option') }}">
