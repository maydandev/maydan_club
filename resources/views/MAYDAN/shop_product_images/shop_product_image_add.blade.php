...
@section('content-header')
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{ __('shop_product_images_shop_product_images') }}</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('shop_product_images.index') }}">{{ __('shop_product_images_shop_product_images') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new shop_product_images_shop_product_image') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/shop_product_images') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('shop_product_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.shop_product_images_shop_product_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="shop_product_id" placeholder="@lang('messages.shop_product_images_shop_product_id')" value="{{ old('shop_product_id') }}">
       ...
       <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.shop_product_images_image') </label>
                            <div class="col-md-6  ">
                                <input type="file" class="form-control" name="image" placeholder="@lang('messages.shop_product_images_image')" value="{{ old('image') }}">
                                @if ($errors->has('image'))
                                    <span class="help-block">
