                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('api_event_types.index') }}">{{ __('api_event_types_api_event_types') }}</a>
								     ...
								     <li class="breadcrumb-item active">{{ __('Add new api_event_types_api_event_type') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/api_event_types') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('event_type') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.api_event_types_event_type')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="event_type" placeholder="@lang('messages.api_event_types_event_type')" value="{{ old('event_type') }}">
