                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('shop_coupon_codes.index') }}">{{ __('shop_coupon_codes_shop_coupon_codes') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new shop_coupon_codes_shop_coupon_code') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/shop_coupon_codes') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('application_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.shop_coupon_codes_application_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="application_id" placeholder="@lang('messages.shop_coupon_codes_application_id')" value="{{ old('application_id') }}">
       ...
       <div class="form-group{{ $errors->has('coupon_code') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.shop_coupon_codes_coupon_code')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="coupon_code" placeholder="@lang('messages.shop_coupon_codes_coupon_code')" value="{{ old('coupon_code') }}">
       ...
       <div class="form-group{{ $errors->has('is_use') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.shop_coupon_codes_is_use')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="is_use" placeholder="@lang('messages.shop_coupon_codes_is_use')" value="{{ old('is_use') }}">
...
<span class="lbl"></span>
       ...
       <div class="form-group{{ $errors->has('coupon_amout') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.shop_coupon_codes_coupon_amout')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="coupon_amout" placeholder="@lang('messages.shop_coupon_codes_coupon_amout')" value="{{ old('coupon_amout') }}">
       ...
       <div class="form-group{{ $errors->has('coupon_discount_type') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.shop_coupon_codes_coupon_discount_type')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="coupon_discount_type" placeholder="@lang('messages.shop_coupon_codes_coupon_discount_type')" value="{{ old('coupon_discount_type') }}">
