...
@section('content-header')
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{ __('countries_countries') }}</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('countries.index') }}">{{ __('countries_countries') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new countries_country') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/countries') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('country') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.countries_country')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="country" placeholder="@lang('messages.countries_country')" value="{{ old('country') }}">
       ...
       <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.countries_code')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="code" placeholder="@lang('messages.countries_code')" value="{{ old('code') }}">
                                @if ($errors->has('code'))
                                    <span class="help-block">
       ...
       <div class="form-group{{ $errors->has('flag') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.countries_flag')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="flag" placeholder="@lang('messages.countries_flag')" value="{{ old('flag') }}">
                                @if ($errors->has('flag'))
                                    <span class="help-block">
