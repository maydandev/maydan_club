                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('first_goal_predictions.index') }}">{{ __('first_goal_predictions_first_goal_predictions') }}</a>
								     ...
								     <li class="breadcrumb-item active">  @lang('messages.first_goal_predictions_show_title') {{$first_goal_prediction->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/first_goal_predictions/{{$first_goal_prediction->id}}"   enctype="multipart/form-data"  novalidate>
  ...
  <ul class="pager">
                 @if($previous)
											<li class="previous">
												<a href="/first_goal_predictions/{{$previous}}"><i class="ace-icon fa fa-angle-double-right"></i> @lang('messages.previous')   </a>
											</li>
                @endif
                @if($next)
											<li class="next">
												<a href="/first_goal_predictions/{{$next}}"> @lang('messages.next')   <i class="ace-icon fa fa-angle-double-left"></i> </a>
											</li>
                @endif
	</ul>
