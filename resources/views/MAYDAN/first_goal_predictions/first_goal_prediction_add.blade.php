...
@section('content-header')
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{ __('first_goal_predictions_first_goal_predictions') }}</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('first_goal_predictions.index') }}">{{ __('first_goal_predictions_first_goal_predictions') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new first_goal_predictions_first_goal_prediction') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/first_goal_predictions') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('fixture_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.first_goal_predictions_fixture_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="fixture_id" placeholder="@lang('messages.first_goal_predictions_fixture_id')" value="{{ old('fixture_id') }}">
       ...
       <div class="form-group{{ $errors->has('prediction_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.first_goal_predictions_prediction_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="prediction_id" placeholder="@lang('messages.first_goal_predictions_prediction_id')" value="{{ old('prediction_id') }}">
       ...
       <div class="form-group{{ $errors->has('result_first_goal_player_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.first_goal_predictions_result_first_goal_player_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="result_first_goal_player_id" placeholder="@lang('messages.first_goal_predictions_result_first_goal_player_id')" value="{{ old('result_first_goal_player_id') }}">
       ...
       <div class="form-group{{ $errors->has('result_first_goal_player_name') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.first_goal_predictions_result_first_goal_player_name')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="result_first_goal_player_name" placeholder="@lang('messages.first_goal_predictions_result_first_goal_player_name')" value="{{ old('result_first_goal_player_name') }}">
       ...
       <div class="form-group{{ $errors->has('data') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6  ">
                                <textarea  class="form-control" name="data" placeholder="@lang('messages.first_goal_predictions_data')"  >{{ old('data') }}</textarea>
                                @if ($errors->has('data'))
                                    <span class="help-block">
