                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('api_event_type_details.index') }}">{{ __('api_event_type_details_api_event_type_details') }}</a>
								     ...
								     <li class="breadcrumb-item active">  @lang('messages.api_event_type_details_show_title') {{$api_event_type_detail->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/api_event_type_details/{{$api_event_type_detail->id}}"   enctype="multipart/form-data"  novalidate>
  ...
  <ul class="pager">
                 @if($previous)
											<li class="previous">
												<a href="/api_event_type_details/{{$previous}}"><i class="ace-icon fa fa-angle-double-right"></i> @lang('messages.previous')   </a>
											</li>
                @endif
                @if($next)
											<li class="next">
												<a href="/api_event_type_details/{{$next}}"> @lang('messages.next')   <i class="ace-icon fa fa-angle-double-left"></i> </a>
											</li>
                @endif
	</ul>
