                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('api_event_type_details.index') }}">{{ __('api_event_type_details_api_event_type_details') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new api_event_type_details_api_event_type_detail') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/api_event_type_details') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('event_type_detail') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.api_event_type_details_event_type_detail')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="event_type_detail" placeholder="@lang('messages.api_event_type_details_event_type_detail')" value="{{ old('event_type_detail') }}">
       ...
       <div class="form-group{{ $errors->has('event_type_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.api_event_type_details_event_type_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="event_type_id" placeholder="@lang('messages.api_event_type_details_event_type_id')" value="{{ old('event_type_id') }}">
