                ...
                <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                    <div class="form-group breadcrum-right">
                        <div class="dropdown">
                            ...
                            <a class="dropdown-item" href="{{ route('cities.create') }}">{{ __('Add new') }}</a>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="mb-0">{{ __('cities_cities') }}</h4>
                                </div>
...
<td>{{ $city->updated_at }}</td>         <td>
           ...
           <a href="{{ route('cities.show', $city) }}"
             ...
             <a href="#" class="btn btn-danger mr-1 mb-1 btn-sm" onclick="confirm('هل أنت متأكد ؟ ');event.preventDefault(); 
                                                document.getElementById('destroy-city_{{ $city->id}}').submit();"><i
                                                        class="fa fa-trash"></i></a>
                                                <form id="destroy-city_{{  $city->id }}"
                                                    action="{{ route('cities.destroy', $city) }}" method="POST"
                                                    style="display: none;">
                                                    @method('DELETE')
                                                    @csrf
                                                </form>
 ...
 @endforeach
        ...
        <tfoot>
       <tr><td   dir="rtl"  colspan="4"  >{{$cities->links("pagination::bootstrap-4")}} </td></tr>
        </tfoot>
