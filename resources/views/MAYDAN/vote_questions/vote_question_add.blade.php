                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('vote_questions.index') }}">{{ __('vote_questions_vote_questions') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new vote_questions_vote_question') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/vote_questions') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('vote_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.vote_questions_vote_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="vote_id" placeholder="@lang('messages.vote_questions_vote_id')" value="{{ old('vote_id') }}">
       ...
       <div class="form-group{{ $errors->has('vote_question') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.vote_questions_vote_question')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="vote_question" placeholder="@lang('messages.vote_questions_vote_question')" value="{{ old('vote_question') }}">
