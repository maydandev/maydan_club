                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('league_types.index') }}">{{ __('league_types_league_types') }}</a>
								     ...
								     <li class="breadcrumb-item active">{{ __('Add new league_types_league_type') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/league_types') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('league_type') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.league_types_league_type')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="league_type" placeholder="@lang('messages.league_types_league_type')" value="{{ old('league_type') }}">
