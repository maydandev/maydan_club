                                            ...
                                            <li class="d-inline-block mr-2">
                                                ...
                                                <fieldset>
                                                 ...
                                                 @foreach($application_football_teams as $key =>  $application_football_team)
                                                    ...
                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                        <input type="checkbox" @if(in_array($application_football_team->football_team_id , $teams)) checked  @endif  class="checkbox" name="application_football_team_ids[]"  value="{{ $application_football_team->football_team_id }}">
                                                        <span class="vs-checkbox vs-checkbox-lg" >
                                                            <span class="vs-checkbox--check">
                                                                <i class="vs-icon feather icon-check"></i>
                                                            </span>
