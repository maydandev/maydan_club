...
@section('content-header')
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{ __('application_football_teams_application_football_teams') }}</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('application_football_teams.index') }}">{{ __('application_football_teams_application_football_teams') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new application_football_teams_application_football_team') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/application_football_teams') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('application_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.application_football_teams_application_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="application_id" placeholder="@lang('messages.application_football_teams_application_id')" value="{{ old('application_id') }}">
       ...
       <div class="form-group{{ $errors->has('football_team_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.application_football_teams_football_team_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="football_team_id" placeholder="@lang('messages.application_football_teams_football_team_id')" value="{{ old('football_team_id') }}">
