                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('notifications.index') }}">{{ __('notifications_notifications') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new notifications_notification') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/notifications') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('application_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.notifications_application_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="application_id" placeholder="@lang('messages.notifications_application_id')" value="{{ old('application_id') }}">
       ...
       <div class="form-group{{ $errors->has('line_ups') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.notifications_line_ups')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="line_ups" placeholder="@lang('messages.notifications_line_ups')" value="{{ old('line_ups') }}">
       ...
       <div class="form-group{{ $errors->has('kick_off') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.notifications_kick_off')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="kick_off" placeholder="@lang('messages.notifications_kick_off')" value="{{ old('kick_off') }}">
       ...
       <div class="form-group{{ $errors->has('goals') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.notifications_goals')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="goals" placeholder="@lang('messages.notifications_goals')" value="{{ old('goals') }}">
                                @if ($errors->has('goals'))
                                    <span class="help-block">
       ...
       <div class="form-group{{ $errors->has('half_time') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.notifications_half_time')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="half_time" placeholder="@lang('messages.notifications_half_time')" value="{{ old('half_time') }}">
       ...
       <div class="form-group{{ $errors->has('full_time') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.notifications_full_time')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="full_time" placeholder="@lang('messages.notifications_full_time')" value="{{ old('full_time') }}">
       ...
       <div class="form-group{{ $errors->has('red_card') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.notifications_red_card')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="red_card" placeholder="@lang('messages.notifications_red_card')" value="{{ old('red_card') }}">
