...
@section('content-header')
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{ __('final_result_user_predictions_final_result_user_predictions') }}</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('final_result_user_predictions.index') }}">{{ __('final_result_user_predictions_final_result_user_predictions') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new final_result_user_predictions_final_result_user_prediction') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/final_result_user_predictions') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('user_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.final_result_user_predictions_user_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="user_id" placeholder="@lang('messages.final_result_user_predictions_user_id')" value="{{ old('user_id') }}">
       ...
       <div class="form-group{{ $errors->has('final_result_prediction_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.final_result_user_predictions_final_result_prediction_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="final_result_prediction_id" placeholder="@lang('messages.final_result_user_predictions_final_result_prediction_id')" value="{{ old('final_result_prediction_id') }}">
       ...
       <div class="form-group{{ $errors->has('home_score') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.final_result_user_predictions_home_score')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="home_score" placeholder="@lang('messages.final_result_user_predictions_home_score')" value="{{ old('home_score') }}">
       ...
       <div class="form-group{{ $errors->has('away_score') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.final_result_user_predictions_away_score')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="away_score" placeholder="@lang('messages.final_result_user_predictions_away_score')" value="{{ old('away_score') }}">
