                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('package_table_categories.index') }}">{{ __('package_table_categories_package_table_categories') }}</a>
								     ...
								     <li class="breadcrumb-item active">{{ __('Add new package_table_categories_package_table_category') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/package_table_categories') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.package_table_categories_name')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="name" placeholder="@lang('messages.package_table_categories_name')" value="{{ old('name') }}">
                                @if ($errors->has('name'))
...
<span class="lbl"></span>
       ...
       <div class="form-group{{ $errors->has('sort') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.package_table_categories_sort')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="sort" placeholder="@lang('messages.package_table_categories_sort')" value="{{ old('sort') }}">
                                @if ($errors->has('sort'))
                                    <span class="help-block">
