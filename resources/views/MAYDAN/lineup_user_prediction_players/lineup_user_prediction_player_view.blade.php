                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('lineup_user_prediction_players.index') }}">{{ __('lineup_user_prediction_players_lineup_user_prediction_players') }}</a>
								     ...
								     <li class="breadcrumb-item active">  @lang('messages.lineup_user_prediction_players_show_title') {{$lineup_user_prediction_player->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/lineup_user_prediction_players/{{$lineup_user_prediction_player->id}}"   enctype="multipart/form-data"  novalidate>
  ...
  <ul class="pager">
                 @if($previous)
											<li class="previous">
												<a href="/lineup_user_prediction_players/{{$previous}}"><i class="ace-icon fa fa-angle-double-right"></i> @lang('messages.previous')   </a>
											</li>
                @endif
                @if($next)
											<li class="next">
												<a href="/lineup_user_prediction_players/{{$next}}"> @lang('messages.next')   <i class="ace-icon fa fa-angle-double-left"></i> </a>
											</li>
                @endif
	</ul>
