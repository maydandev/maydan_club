                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('clubs.index') }}">{{ __('clubs_clubs') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new clubs_club') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/clubs') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.clubs_code')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="code" placeholder="@lang('messages.clubs_code')" value="{{ old('code') }}">
                                @if ($errors->has('code'))
       ...
       <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.clubs_name')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="name" placeholder="@lang('messages.clubs_name')" value="{{ old('name') }}">
                                @if ($errors->has('name'))
                                    <span class="help-block">
       ...
       <div class="form-group{{ $errors->has('logo') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.clubs_logo') </label>
                            <div class="col-md-6  ">
                                <input type="file" class="form-control" name="logo" placeholder="@lang('messages.clubs_logo')" value="{{ old('logo') }}">
                                @if ($errors->has('logo'))
                                    <span class="help-block">
                            ...
                            @foreach($representatives as $representative)
                             <option    value="{{ $representative->id }}" >{{ $representative->user_id }}</option>
                             @endforeach
                            </select>
       ...
       <div class="form-group{{ $errors->has('profiles') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.clubs_profiles')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="profiles" placeholder="@lang('messages.clubs_profiles')" value="{{ old('profiles') }}">
       ...
       <div class="form-group{{ $errors->has('usage_data') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.clubs_usage_data')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="usage_data" placeholder="@lang('messages.clubs_usage_data')" value="{{ old('usage_data') }}">
       ...
       <div class="form-group{{ $errors->has('join_date') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.clubs_join_date')</label>
                            <div class="col-md-6  ">
                                <input type="date" class="form-control" name="join_date" placeholder="@lang('messages.clubs_join_date')" value="{{ old('join_date') }}">
