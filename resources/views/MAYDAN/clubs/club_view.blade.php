                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('clubs.index') }}">{{ __('clubs_clubs') }}</a>
								     ...
								     <li class="breadcrumb-item active">  @lang('messages.clubs_show_title') {{$club->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/clubs/{{$club->id}}"   enctype="multipart/form-data"  novalidate>
...
<span class="lbl"></span>
  ...
  <ul class="pager">
                 @if($previous)
											<li class="previous">
												<a href="/clubs/{{$previous}}"><i class="ace-icon fa fa-angle-double-right"></i> @lang('messages.previous')   </a>
											</li>
                @endif
                @if($next)
											<li class="next">
												<a href="/clubs/{{$next}}"> @lang('messages.next')   <i class="ace-icon fa fa-angle-double-left"></i> </a>
											</li>
                @endif
	</ul>
