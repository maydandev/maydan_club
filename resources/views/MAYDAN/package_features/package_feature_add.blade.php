...
@section('content-header')
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{ __('package_features_package_features') }}</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('package_features.index') }}">{{ __('package_features_package_features') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new package_features_package_feature') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/package_features') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('package_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.package_features_package_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="package_id" placeholder="@lang('messages.package_features_package_id')" value="{{ old('package_id') }}">
       ...
       <div class="form-group{{ $errors->has('feature') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.package_features_feature')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="feature" placeholder="@lang('messages.package_features_feature')" value="{{ old('feature') }}">
