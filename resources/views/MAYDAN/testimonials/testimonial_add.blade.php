...
@section('content-header')
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{ __('testimonials_testimonials') }}</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('testimonials.index') }}">{{ __('testimonials_testimonials') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new testimonials_testimonial') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/testimonials') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.testimonials_title')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="title" placeholder="@lang('messages.testimonials_title')" value="{{ old('title') }}">
                                @if ($errors->has('title'))
       ...
       <div class="form-group{{ $errors->has('text') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6  ">
                                <textarea  class="form-control" name="text" placeholder="@lang('messages.testimonials_text')"  >{{ old('text') }}</textarea>
                                @if ($errors->has('text'))
                                    <span class="help-block">
       ...
       <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.testimonials_image') </label>
                            <div class="col-md-6  ">
                                <input type="file" class="form-control" name="image" placeholder="@lang('messages.testimonials_image')" value="{{ old('image') }}">
                                @if ($errors->has('image'))
                                    <span class="help-block">
...
<span class="lbl"></span>
       ...
       <div class="form-group{{ $errors->has('sort') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.testimonials_sort')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="sort" placeholder="@lang('messages.testimonials_sort')" value="{{ old('sort') }}">
                                @if ($errors->has('sort'))
                                    <span class="help-block">
