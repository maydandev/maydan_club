                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('modules.index') }}">{{ __('modules_modules') }}</a>
								     ...
								     <li class="breadcrumb-item active">{{ __('Add new modules_module') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/modules') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.modules_name')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="name" placeholder="@lang('messages.modules_name')" value="{{ old('name') }}">
                                @if ($errors->has('name'))
       ...
       <div class="form-group{{ $errors->has('en_name') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.modules_en_name')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="en_name" placeholder="@lang('messages.modules_en_name')" value="{{ old('en_name') }}">
       ...
       <div class="form-group{{ $errors->has('route') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.modules_route')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="route" placeholder="@lang('messages.modules_route')" value="{{ old('route') }}">
                                @if ($errors->has('route'))
                                    <span class="help-block">
       ...
       <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.modules_image') </label>
                            <div class="col-md-6  ">
                                <input type="file" class="form-control" name="image" placeholder="@lang('messages.modules_image')" value="{{ old('image') }}">
                                @if ($errors->has('image'))
                                    <span class="help-block">
       ...
       <div class="form-group{{ $errors->has('icon') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.modules_icon')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="icon" placeholder="@lang('messages.modules_icon')" value="{{ old('icon') }}">
                                @if ($errors->has('icon'))
                                    <span class="help-block">
       ...
       <div class="form-group{{ $errors->has('parent_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.modules_parent_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="parent_id" placeholder="@lang('messages.modules_parent_id')" value="{{ old('parent_id') }}">
       ...
       <div class="form-group{{ $errors->has('user_type_ids') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.modules_user_type_ids')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="user_type_ids" placeholder="@lang('messages.modules_user_type_ids')" value="{{ old('user_type_ids') }}">
       ...
       <div class="form-group{{ $errors->has('app_type') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.modules_app_type')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="app_type" placeholder="@lang('messages.modules_app_type')" value="{{ old('app_type') }}">
       ...
       <div class="form-group{{ $errors->has('sorting') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.modules_sorting')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="sorting" placeholder="@lang('messages.modules_sorting')" value="{{ old('sorting') }}">
