                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('app_releases.index') }}">{{ __('app_releases_app_releases') }}</a>
								     ...
								     <li class="breadcrumb-item active">  @lang('messages.app_releases_show_title') {{$app_release->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/app_releases/{{$app_release->id}}"   enctype="multipart/form-data"  novalidate>
...
<span class="lbl"></span>
  ...
  <ul class="pager">
                 @if($previous)
											<li class="previous">
												<a href="/app_releases/{{$previous}}"><i class="ace-icon fa fa-angle-double-right"></i> @lang('messages.previous')   </a>
											</li>
                @endif
                @if($next)
											<li class="next">
												<a href="/app_releases/{{$next}}"> @lang('messages.next')   <i class="ace-icon fa fa-angle-double-left"></i> </a>
											</li>
                @endif
	</ul>
