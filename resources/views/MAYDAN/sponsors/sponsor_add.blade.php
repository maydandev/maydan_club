...
@section('content-header')
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{ __('sponsors_sponsors') }}</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('sponsors.index') }}">{{ __('sponsors_sponsors') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new sponsors_sponsor') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/sponsors') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.sponsors_name')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="name" placeholder="@lang('messages.sponsors_name')" value="{{ old('name') }}">
                                @if ($errors->has('name'))
                                    <span class="help-block">
       ...
       <div class="form-group{{ $errors->has('application_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.sponsors_application_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="application_id" placeholder="@lang('messages.sponsors_application_id')" value="{{ old('application_id') }}">
                            ...
                            @foreach($sponsor_types as $sponsor_type)
                             <option    value="{{ $sponsor_type->id }}" >{{ $sponsor_type->name }}</option>
                             @endforeach
                            </select>
       ...
       <div class="form-group{{ $errors->has('icon') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.sponsors_icon')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="icon" placeholder="@lang('messages.sponsors_icon')" value="{{ old('icon') }}">
                                @if ($errors->has('icon'))
                                    <span class="help-block">
