                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('sponsors.index') }}">{{ __('sponsors_sponsors') }}</a>
								     ...
								     <li class="breadcrumb-item active">  @lang('messages.sponsors_show_title') {{$sponsor->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/sponsors/{{$sponsor->id}}"   enctype="multipart/form-data"  novalidate>
...
<span class="lbl"></span>
  ...
  <ul class="pager">
                 @if($previous)
											<li class="previous">
												<a href="/sponsors/{{$previous}}"><i class="ace-icon fa fa-angle-double-right"></i> @lang('messages.previous')   </a>
											</li>
                @endif
                @if($next)
											<li class="next">
												<a href="/sponsors/{{$next}}"> @lang('messages.next')   <i class="ace-icon fa fa-angle-double-left"></i> </a>
											</li>
                @endif
	</ul>
