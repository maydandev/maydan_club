...
@section('content')
@section('title','إضافة سؤال اخر')
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">إضافة سؤال اخر</h2>
            ...
            <div class="col-md-12 col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">إضافة سؤال اخر</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" method="POST" action="/admin/quizzes/{{$id}}/more"
