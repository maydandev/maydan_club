                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('notification_types.index') }}">{{ __('notification_types_notification_types') }}</a>
                                    </li>
								     <li class="breadcrumb-item active">  @lang('messages.notification_types_show_title') {{$notification_type->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/notification_types/{{$notification_type->id}}"   enctype="multipart/form-data"  novalidate>
  ...
  {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
            <label class="col-md-4 control-label  "> @lang('messages.notification_types_name')</label>
                            <div class="col-md-6 ">
                                <input type="text" class="form-control" name="name" placeholder="@lang('messages.notification_types_name')" value="{{ $notification_type->name }}">
                                @if ($errors->has('name'))
  ...
  <ul class="pager">
                 @if($previous)
											<li class="previous">
												<a href="/notification_types/{{$previous}}"><i class="ace-icon fa fa-angle-double-right"></i> @lang('messages.previous')   </a>
											</li>
                @endif
                @if($next)
											<li class="next">
												<a href="/notification_types/{{$next}}"> @lang('messages.next')   <i class="ace-icon fa fa-angle-double-left"></i> </a>
											</li>
                @endif
	</ul>
