                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('shop_order_details.index') }}">{{ __('shop_order_details_shop_order_details') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new shop_order_details_shop_order_detail') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/shop_order_details') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('shop_order_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.shop_order_details_shop_order_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="shop_order_id" placeholder="@lang('messages.shop_order_details_shop_order_id')" value="{{ old('shop_order_id') }}">
       ...
       <div class="form-group{{ $errors->has('shop_product_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.shop_order_details_shop_product_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="shop_product_id" placeholder="@lang('messages.shop_order_details_shop_product_id')" value="{{ old('shop_product_id') }}">
       ...
       <div class="form-group{{ $errors->has('products_model') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.shop_order_details_products_model')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="products_model" placeholder="@lang('messages.shop_order_details_products_model')" value="{{ old('products_model') }}">
       ...
       <div class="form-group{{ $errors->has('products_name') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.shop_order_details_products_name')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="products_name" placeholder="@lang('messages.shop_order_details_products_name')" value="{{ old('products_name') }}">
       ...
       <div class="form-group{{ $errors->has('products_price') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.shop_order_details_products_price')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="products_price" placeholder="@lang('messages.shop_order_details_products_price')" value="{{ old('products_price') }}">
       ...
       <div class="form-group{{ $errors->has('final_price') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.shop_order_details_final_price')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="final_price" placeholder="@lang('messages.shop_order_details_final_price')" value="{{ old('final_price') }}">
       ...
       <div class="form-group{{ $errors->has('products_tax') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.shop_order_details_products_tax')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="products_tax" placeholder="@lang('messages.shop_order_details_products_tax')" value="{{ old('products_tax') }}">
       ...
       <div class="form-group{{ $errors->has('products_quantity') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.shop_order_details_products_quantity')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="products_quantity" placeholder="@lang('messages.shop_order_details_products_quantity')" value="{{ old('products_quantity') }}">
