                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('applications.index') }}">{{ __('applications_applications') }}</a>
								     ...
								     <li class="breadcrumb-item active">{{ __('Add new applications_application') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/applications') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.applications_name')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="name" placeholder="@lang('messages.applications_name')" value="{{ old('name') }}">
                                @if ($errors->has('name'))
       ...
       <div class="form-group{{ $errors->has('icon') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.applications_icon')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="icon" placeholder="@lang('messages.applications_icon')" value="{{ old('icon') }}">
                                @if ($errors->has('icon'))
                                    <span class="help-block">
       ...
       <div class="form-group{{ $errors->has('language') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.applications_language')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="language" placeholder="@lang('messages.applications_language')" value="{{ old('language') }}">
       ...
       <div class="form-group{{ $errors->has('primary_color') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.applications_primary_color')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="primary_color" placeholder="@lang('messages.applications_primary_color')" value="{{ old('primary_color') }}">
       ...
       <div class="form-group{{ $errors->has('secondary_color') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.applications_secondary_color')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="secondary_color" placeholder="@lang('messages.applications_secondary_color')" value="{{ old('secondary_color') }}">
       ...
       <div class="form-group{{ $errors->has('alternative_primary_color') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.applications_alternative_primary_color')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="alternative_primary_color" placeholder="@lang('messages.applications_alternative_primary_color')" value="{{ old('alternative_primary_color') }}">
       ...
       <div class="form-group{{ $errors->has('alternative_secondary_color') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.applications_alternative_secondary_color')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="alternative_secondary_color" placeholder="@lang('messages.applications_alternative_secondary_color')" value="{{ old('alternative_secondary_color') }}">
       ...
       <div class="form-group{{ $errors->has('is_gradient_primary_color') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.applications_is_gradient_primary_color')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="is_gradient_primary_color" placeholder="@lang('messages.applications_is_gradient_primary_color')" value="{{ old('is_gradient_primary_color') }}">
       ...
       <div class="form-group{{ $errors->has('is_gradient_secondary_color') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.applications_is_gradient_secondary_color')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="is_gradient_secondary_color" placeholder="@lang('messages.applications_is_gradient_secondary_color')" value="{{ old('is_gradient_secondary_color') }}">
       ...
       <div class="form-group{{ $errors->has('currency') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.applications_currency')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="currency" placeholder="@lang('messages.applications_currency')" value="{{ old('currency') }}">
       ...
       <div class="form-group{{ $errors->has('club_logo') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.applications_club_logo')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="club_logo" placeholder="@lang('messages.applications_club_logo')" value="{{ old('club_logo') }}">
       ...
       <div class="form-group{{ $errors->has('team_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.applications_team_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="team_id" placeholder="@lang('messages.applications_team_id')" value="{{ old('team_id') }}">
       ...
       <div class="form-group{{ $errors->has('splash_image') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.applications_splash_image')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="splash_image" placeholder="@lang('messages.applications_splash_image')" value="{{ old('splash_image') }}">
       ...
       <div class="form-group{{ $errors->has('current_league_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.applications_current_league_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="current_league_id" placeholder="@lang('messages.applications_current_league_id')" value="{{ old('current_league_id') }}">
       ...
       <div class="form-group{{ $errors->has('current_season') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.applications_current_season')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="current_season" placeholder="@lang('messages.applications_current_season')" value="{{ old('current_season') }}">
       ...
       <div class="form-group{{ $errors->has('base_url') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.applications_base_url')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="base_url" placeholder="@lang('messages.applications_base_url')" value="{{ old('base_url') }}">
       ...
       <div class="form-group{{ $errors->has('configuration') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.applications_configuration')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="configuration" placeholder="@lang('messages.applications_configuration')" value="{{ old('configuration') }}">
       ...
       <div class="form-group{{ $errors->has('club_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.applications_club_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="club_id" placeholder="@lang('messages.applications_club_id')" value="{{ old('club_id') }}">
