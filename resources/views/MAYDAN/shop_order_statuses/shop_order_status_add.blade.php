                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('shop_order_statuses.index') }}">{{ __('shop_order_statuses_shop_order_statuses') }}</a>
								     ...
								     <li class="breadcrumb-item active">{{ __('Add new shop_order_statuses_shop_order_status') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/shop_order_statuses') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.shop_order_statuses_name')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="name" placeholder="@lang('messages.shop_order_statuses_name')" value="{{ old('name') }}">
                                @if ($errors->has('name'))
       ...
       <div class="form-group{{ $errors->has('en_name') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.shop_order_statuses_en_name')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="en_name" placeholder="@lang('messages.shop_order_statuses_en_name')" value="{{ old('en_name') }}">
       ...
       <div class="form-group{{ $errors->has('color') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.shop_order_statuses_color')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="color" placeholder="@lang('messages.shop_order_statuses_color')" value="{{ old('color') }}">
                                @if ($errors->has('color'))
                                    <span class="help-block">
