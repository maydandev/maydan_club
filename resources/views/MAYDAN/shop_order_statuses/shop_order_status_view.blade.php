...
@section('content-header')
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{ __('shop_order_statuses_shop_order_statuses') }}</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('shop_order_statuses.index') }}">{{ __('shop_order_statuses_shop_order_statuses') }}</a>
                                    </li>
								     <li class="breadcrumb-item active">  @lang('messages.shop_order_statuses_show_title') {{$shop_order_status->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/shop_order_statuses/{{$shop_order_status->id}}"   enctype="multipart/form-data"  novalidate>
  ...
  {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
            <label class="col-md-4 control-label  "> @lang('messages.shop_order_statuses_name')</label>
                            <div class="col-md-6 ">
                                <input type="text" class="form-control" name="name" placeholder="@lang('messages.shop_order_statuses_name')" value="{{ $shop_order_status->name }}">
                                @if ($errors->has('name'))
       ...
       <div class="form-group{{ $errors->has('en_name') ? ' has-error' : '' }}">
            <label class="col-md-4 control-label  "> @lang('messages.shop_order_statuses_en_name')</label>
                            <div class="col-md-6 ">
                                <input type="text" class="form-control" name="en_name" placeholder="@lang('messages.shop_order_statuses_en_name')" value="{{ $shop_order_status->en_name }}">
       ...
       <div class="form-group{{ $errors->has('color') ? ' has-error' : '' }}">
            <label class="col-md-4 control-label  "> @lang('messages.shop_order_statuses_color')</label>
                            <div class="col-md-6 ">
                                <input type="text" class="form-control" name="color" placeholder="@lang('messages.shop_order_statuses_color')" value="{{ $shop_order_status->color }}">
                                @if ($errors->has('color'))
                                    <span class="help-block">
  ...
  <ul class="pager">
                 @if($previous)
											<li class="previous">
												<a href="/shop_order_statuses/{{$previous}}"><i class="ace-icon fa fa-angle-double-right"></i> @lang('messages.previous')   </a>
											</li>
                @endif
                @if($next)
											<li class="next">
												<a href="/shop_order_statuses/{{$next}}"> @lang('messages.next')   <i class="ace-icon fa fa-angle-double-left"></i> </a>
											</li>
                @endif
	</ul>
