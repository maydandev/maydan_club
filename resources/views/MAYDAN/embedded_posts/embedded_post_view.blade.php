                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('embedded_posts.index') }}">{{ __('embedded_posts_embedded_posts') }}</a>
								     ...
								     <li class="breadcrumb-item active">  @lang('embedded_posts_show_title') {{$embedded_post->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/embedded_posts/{{$embedded_post->id}}"   enctype="multipart/form-data"  novalidate>
                                                ...
                                                <fieldset>
                                                 ...
                                                 @foreach($platforms as $key =>  $platform)
                                                    ...
                                                    <div class="vs-radio-con vs-radio-primary">
                                                        <input type="radio" name="post_platform" @if( $embedded_post->post_platform   == $platform->name ) checked  @endif  value="{{ $platform->name }}">
