                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('subdomains.index') }}">{{ __('subdomains_subdomains') }}</a>
								     ...
								     <li class="breadcrumb-item active">  @lang('messages.subdomains_show_title') {{$subdomain->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/subdomains/{{$subdomain->id}}"   enctype="multipart/form-data"  novalidate>
...
<span class="lbl"></span>
  ...
  <ul class="pager">
                 @if($previous)
											<li class="previous">
												<a href="/subdomains/{{$previous}}"><i class="ace-icon fa fa-angle-double-right"></i> @lang('messages.previous')   </a>
											</li>
                @endif
                @if($next)
											<li class="next">
												<a href="/subdomains/{{$next}}"> @lang('messages.next')   <i class="ace-icon fa fa-angle-double-left"></i> </a>
											</li>
                @endif
	</ul>
