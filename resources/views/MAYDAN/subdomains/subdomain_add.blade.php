                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('subdomains.index') }}">{{ __('subdomains_subdomains') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new subdomains_subdomain') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/subdomains') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('subdomain') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.subdomains_subdomain')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="subdomain" placeholder="@lang('messages.subdomains_subdomain')" value="{{ old('subdomain') }}">
...
<span class="lbl"></span>
       ...
       <div class="form-group{{ $errors->has('is_verified') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.subdomains_is_verified')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="is_verified" placeholder="@lang('messages.subdomains_is_verified')" value="{{ old('is_verified') }}">
       ...
       <div class="form-group{{ $errors->has('is_accepted') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.subdomains_is_accepted')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="is_accepted" placeholder="@lang('messages.subdomains_is_accepted')" value="{{ old('is_accepted') }}">
       ...
       <div class="form-group{{ $errors->has('user_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.subdomains_user_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="user_id" placeholder="@lang('messages.subdomains_user_id')" value="{{ old('user_id') }}">
       ...
       <div class="form-group{{ $errors->has('club_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.subdomains_club_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="club_id" placeholder="@lang('messages.subdomains_club_id')" value="{{ old('club_id') }}">
       ...
       <div class="form-group{{ $errors->has('application_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.subdomains_application_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="application_id" placeholder="@lang('messages.subdomains_application_id')" value="{{ old('application_id') }}">
