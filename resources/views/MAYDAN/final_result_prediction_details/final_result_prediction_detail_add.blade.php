...
@section('content-header')
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{ __('final_result_prediction_details_final_result_prediction_details') }}</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('final_result_prediction_details.index') }}">{{ __('final_result_prediction_details_final_result_prediction_details') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new final_result_prediction_details_final_result_prediction_detail') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/final_result_prediction_details') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('final_result_prediction_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.final_result_prediction_details_final_result_prediction_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="final_result_prediction_id" placeholder="@lang('messages.final_result_prediction_details_final_result_prediction_id')" value="{{ old('final_result_prediction_id') }}">
       ...
       <div class="form-group{{ $errors->has('user_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.final_result_prediction_details_user_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="user_id" placeholder="@lang('messages.final_result_prediction_details_user_id')" value="{{ old('user_id') }}">
       ...
       <div class="form-group{{ $errors->has('home_team_result') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.final_result_prediction_details_home_team_result')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="home_team_result" placeholder="@lang('messages.final_result_prediction_details_home_team_result')" value="{{ old('home_team_result') }}">
       ...
       <div class="form-group{{ $errors->has('away_team_result') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.final_result_prediction_details_away_team_result')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="away_team_result" placeholder="@lang('messages.final_result_prediction_details_away_team_result')" value="{{ old('away_team_result') }}">
