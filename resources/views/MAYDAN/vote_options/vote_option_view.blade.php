...
@section('content-header')
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{ __('vote_options_vote_options') }}</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('vote_options.index') }}">{{ __('vote_options_vote_options') }}</a>
                                    </li>
								     <li class="breadcrumb-item active">  @lang('messages.vote_options_show_title') {{$vote_option->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/vote_options/{{$vote_option->id}}"   enctype="multipart/form-data"  novalidate>
  ...
  {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('vote_id') ? ' has-error' : '' }}">
            <label class="col-md-4 control-label  "> @lang('messages.vote_options_vote_id')</label>
                            <div class="col-md-6 ">
                                <input type="number" class="form-control" name="vote_id" placeholder="@lang('messages.vote_options_vote_id')" value="{{ $vote_option->vote_id }}">
       ...
       <div class="form-group{{ $errors->has('vote_option') ? ' has-error' : '' }}">
            <label class="col-md-4 control-label  "> @lang('messages.vote_options_vote_option')</label>
                            <div class="col-md-6 ">
                                <input type="text" class="form-control" name="vote_option" placeholder="@lang('messages.vote_options_vote_option')" value="{{ $vote_option->vote_option }}">
                                @if ($errors->has('vote_option'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('vote_option') }}</strong>
                                    </span>
                                @endif
                            </div>
  ...
  <ul class="pager">
                 @if($previous)
											<li class="previous">
												<a href="/vote_options/{{$previous}}"><i class="ace-icon fa fa-angle-double-right"></i> @lang('messages.previous')   </a>
											</li>
                @endif
                @if($next)
											<li class="next">
												<a href="/vote_options/{{$next}}"> @lang('messages.next')   <i class="ace-icon fa fa-angle-double-left"></i> </a>
											</li>
                @endif
	</ul>
