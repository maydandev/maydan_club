                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('vote_options.index') }}">{{ __('vote_options_vote_options') }}</a>
								     ...
								     <li class="breadcrumb-item active">{{ __('Add new vote_options_vote_option') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/vote_options') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('vote_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.vote_options_vote_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="vote_id" placeholder="@lang('messages.vote_options_vote_id')" value="{{ old('vote_id') }}">
       ...
       <div class="form-group{{ $errors->has('vote_option') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.vote_options_vote_option')</label>
                            <div class="col-md-6  ">
                                <input type="text" class="form-control" name="vote_option" placeholder="@lang('messages.vote_options_vote_option')" value="{{ old('vote_option') }}">
