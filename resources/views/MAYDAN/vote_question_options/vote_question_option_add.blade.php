...
@section('content-header')
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{ __('vote_question_options_vote_question_options') }}</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('vote_question_options.index') }}">{{ __('vote_question_options_vote_question_options') }}</a>
                                    </li>
                                   

								     <li class="breadcrumb-item active">{{ __('Add new vote_question_options_vote_question_option') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/vote_question_options') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
       ...
       <div class="form-group{{ $errors->has('vote_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.vote_question_options_vote_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="vote_id" placeholder="@lang('messages.vote_question_options_vote_id')" value="{{ old('vote_id') }}">
       ...
       <div class="form-group{{ $errors->has('vote_question_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.vote_question_options_vote_question_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="vote_question_id" placeholder="@lang('messages.vote_question_options_vote_question_id')" value="{{ old('vote_question_id') }}">
       ...
       <div class="form-group{{ $errors->has('vote_option_id') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.vote_question_options_vote_option_id')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="vote_option_id" placeholder="@lang('messages.vote_question_options_vote_option_id')" value="{{ old('vote_option_id') }}">
       ...
       <div class="form-group{{ $errors->has('percentage') ? ' has-error' : '' }}">
         <label class="col-md-4 control-label  ">@lang('messages.vote_question_options_percentage')</label>
                            <div class="col-md-6  ">
                                <input type="number" class="form-control" name="percentage" placeholder="@lang('messages.vote_question_options_percentage')" value="{{ old('percentage') }}">
